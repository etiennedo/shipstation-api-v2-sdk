...
export declare class RatesService {
     ...
     * @throws ApiError
     */
    static calculateRates(requestBody: calculate_rates_request_body): CancelablePromise<calculate_rates_response_body>;
    /**
     * Estimate rates
     * Get Rate Estimates
     * @param requestBody
     ...
     * @throws ApiError
     */
    static estimateRates(requestBody: estimate_rates_request_body): CancelablePromise<estimate_rates_response_body>;
    /**
     * Get rate by id
     ...
     * @throws ApiError
     */
    static getRateById(rateId: se_id): CancelablePromise<get_rate_by_id_response_body>;
}
